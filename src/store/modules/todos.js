...
// the commit parameter is waht is used to call a mutation 
    ...
    async addTodo({commit}, title){
        const response = await axios.post('https://www.yotemarket.co.ke/kev/index.php',{title,  completed: false});
...
const mutations = {
    ...
    // it takes in two parameters, the state and the todos (left side of arrow function) and sets the state.todos to the todos that are received from API(right side of arrow function)
